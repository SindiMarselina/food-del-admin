...
const Add = ({ url }) => {
  ...
  const [data, setData] = useState({
    ...
    description: "",
    price: "",
    category: "" // default kosong, harus dipilih manual
  });
  ...
  const onSubmitHandler = async (event) => {
    ...
    // Validasi wajib semua field diisi
    if (!data.name || !data.description || !data.price || !data.category || !image) {
      toast.error("Semua field wajib diisi, termasuk kategori dan gambar!");
      return;
    }
